...
* Which lines of the following interface do not compile? (Choose all that apply.)
   ...
   Line 1 compiles, as this is a functional interface
   and contains exactly one abstract method: startGame().
   Note that equals(Object) on line 8 does not contribute
   to the abstract method count, as it is always provided by java.lang.Object.
   ...
   Line 7 also does not compile,as static interface methods are not permitted to call default,
   abstract, or non-static private interface methods.
