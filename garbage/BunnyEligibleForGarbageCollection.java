 ...
 */
public class BunnyEligibleForGarbageCollection implements Hops { // 2:
    public static void main(String... unusedData) { // 3:
        BunnyEligibleForGarbageCollection fluffy = new BunnyEligibleForGarbageCollection(); //   4:
        BunnyEligibleForGarbageCollection silly = new BunnyEligibleForGarbageCollection(); //   5:
        BunnyEligibleForGarbageCollection snuggly = new BunnyEligibleForGarbageCollection(); //  6:
        Hops hopper = fluffy; //  7:
        fluffy = null; // 8:
        silly = (BunnyEligibleForGarbageCollection)hopper; //  9:
        hopper = snuggly; //  10:
        snuggly = null; //  11:
        System.gc(); //  12:
    } //  13:
