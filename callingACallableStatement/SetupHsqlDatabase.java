  ...
  package callingACallableStatement; 
  import java.sql.*;

public class SetupHsqlDatabase {

  static String readENames(){
  ...
  static String  readNamesByLetter(){
  ...
  static String  magicNumber(){
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(url);
            ...
            String noParams = readENames();
 
            String inParam = readNamesByLetter();
 
            String inOutParam = doubleNumber();
 
            String outParam =  magicNumber();
