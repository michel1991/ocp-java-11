...
class Bird { // 1:
 ...
 class Parrot extends Bird { // 7:
   ...
   public class Macaw extends Parrot { // 12:
    public Macaw(int z) { super(z); } //  13:
    public Macaw fly() { //    14:
        return new Macaw(3); //  15:
    } //   16:

    static void rewriteCastingLine19( Bird p){
        System.out.println();
        Bird birdHoldMacaw = p.fly();
        Parrot theParrotHoldMacaw =  (Parrot)birdHoldMacaw;
        System.out.print("rewrite result below: ");
        System.out.print( theParrotHoldMacaw.feathers);
        System.out.println();
    }
    public static void main(String... sing) { //  17:
        Bird p = new Macaw(4); //  18:
        System.out.print(((Parrot)p.fly()).feathers); //  19: original
        rewriteCastingLine19(p);
    } } // 20: