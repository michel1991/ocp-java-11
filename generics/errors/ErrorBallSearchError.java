...
public class ErrorBallSearchError<X> {
    ...
    /**
     ...
     We can eliminate options A and E.
     We can also eliminate option C because fetchBall() has the <X> in the wrong place.
     It needs to be after the static keyword. The other methods all compile.
     Option G is correct because inflateBall() redefines X so the type on Ball is hidden.
