package classInitialization.defaultConstructor;
...
/**
   Which of the following classes have a default constructor?
    ...
    The Java compiler automatically adds a constructor that takes no argument and has the same access as the class,
    ...
    For class B, the programmer has defined a constructor that is exactly same as the default constructor that would have been provided automatically.
    It is a matter of interpretation whether it can be called a default constructor or not.
    
    Based on Java Language Specification section 8.8.9
    (https://docs.oracle.com/javase/specs/jls/se11/html/jls-8.html#jls-8.8.9) , quoted below,
    our interpretation is that class B will not get a default constructor:
    ...
    does not have an accessible constructor (6.6) that takes no arguments and has no throws clause.
