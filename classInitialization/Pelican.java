...
/**
   What is the result of the following code?
    ...
    The question is making sure you know that superclass constructors
    ...
    The program then calls the constructor on line 3 and prints Wow-.
    Control then returns to line 6, and Oh- is printed.
    ...
    If the reference type of chirp was Bird,
    then the code would not compile as it would not be accessible outside the class.
 */
