  ...
  E. Only option 3 is valid.
   ...
   The rules are:
    ...
    2. final variables must be explicitly initialized.
        ...
        it is entirely possible that this field can be accessed before even a  single instance is created.
...
class Widget{
    // static int MAX;     //1
      static int MAX = 111; static final String CLASS_GUID = "XYZ123";    //1 response A
    // static final String CLASS_GUID;   // 2
    Widget(){
        //3
    }
