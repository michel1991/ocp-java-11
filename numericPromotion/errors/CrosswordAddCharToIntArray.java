 ...
 *  Which of the following are true? (Choose two.)
    ...
    Line 24 does not compile because arrays use length. It is ArrayList that uses size().
    All of the other lines compile, making option A correct.
    It is permitted to split up the brackets, [], in the 2D array declaration on line 20.
    ...
    The array starts out with all two hundred of the cells initialized to the default value for an int of 0.
 ...
 */
public class CrosswordAddCharToIntArray {
