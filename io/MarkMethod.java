...
public class MarkMethod {
    /**
    *  Assume in and out are valid streams and the next characters of in are MONKEYS. What are possible results of executing the following method? (Choose all that apply.)
