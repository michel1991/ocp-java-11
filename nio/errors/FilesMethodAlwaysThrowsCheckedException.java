...
public class FilesMethodAlwaysThrowsCheckedException {
    ...
    /**
       For which values of path sent to this method would it be possible
        for the following code to output Success? (Choose all that apply.)
      ...
      The code does not compile, as Files.deleteIfExists() declares
      ...
      If the method was corrected to declare the appropriate exceptions,
     ...
     */
    static public void removeBadFile(Path path) {
