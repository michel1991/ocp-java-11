...
public class RelativizeMethodRequireBothAbsolutePath {
    /**
     Assuming that the current directory is /zoo, what is the output of the following code?
       ...
       Note that if the last line were changed to use the absolute path /zoo,
       the answer would be option A since the path from /zoo/elephant to /zoo is the .. path symbol.
 */
