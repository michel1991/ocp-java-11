       ...
       What will the following code fragment print?
         ...
         B.
            \personal\index.html
             --------------
                Observe what happens when you append this path to p1:
                    \personal\readme.txt + \personal\index.html
                =>\personal\readme.txt\\personal\index.html
         ...
         D.
              ..\..\index.html
                ...
                A ".." implies parent folder, therefore imagine that you are taking off one ".."
                from the right side of the plus sign and removing the last name of the path on the left side of the plus sign.
        ...
        This method attempts to construct a relative path that when resolved against this path, yields a path that
        locates the same file as the given path. For example, on UNIX, if this path is "/a/b" and the given path is "/a/b/c/d"
        ...
        For example, if this path is "/a/b" and the given path is "/a/x" then the resulting relative path may be "../x". If "b"
        is a symbolic link then is implementation dependent if "a/b/../x" would locate the same file as "/a/x".
         Correct(D)
