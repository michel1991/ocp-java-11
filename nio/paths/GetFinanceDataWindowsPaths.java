...
Thus, in case of "c:\\finance\\data\\reports\\daily\\pnl.txt", name at 0 is finance and name at 2 is reports.
However, since the name at endIndex is excluded, subpath(0, 2) will correspond to finance\data.
...
The returned Path object has the name elements that begin
at beginIndex and extend to the element at index endIndex-1.
...
Throws:
IllegalArgumentException - if beginIndex is negative, or greater than or equal to the number of elements.
If endIndex is less than or equal to beginIndex, or larger than the number of elements.
   Correct(A)

 */
public class GetFinanceDataWindowsPaths { // correct PathTest
