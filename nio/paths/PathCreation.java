...
public class PathCreation {
    /**
     Which of the following correctly create NIO.2 Path instances? (Choose all that apply.)
      ...
      Remember, the second argument in the version of Paths.get()
      that takes a String is a vararg, which can be passed as a String array.
      Finally, option F is incorrect because the factory
      class FileSystems should be used to get the default FileSystem.
