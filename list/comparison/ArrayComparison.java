...
public class ArrayComparison {
    ...
    /**
       What is printed by the following code? (Choose all that apply.)
        ...
        The ArrayList uses the diamond operator. This specifies the type matches the one on the left without having to retype it.
        ...
        Option C is incorrect because arrays output something that looks like a reference that rather than a nicely printed list of values.
        Option E is correct because the compare() method returns 0 when the arrays are the same length and have the same elements.
