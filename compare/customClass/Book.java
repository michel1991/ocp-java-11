 ...
 *
    ...
    C. It will print the list as it is.
        1. Manipulating a stream doesn't manipulate the backing source of the stream.
            Here, when you chain the sorted method to a stream, it returns a reference to a Stream
            that appears sorted. The original List which was used to create the stream will remain as it is.
   ...
   E. Code will fail to compile because of code at //2.
        ...
        This obviously does not capture Comparator interface. However, Comparator has three
        flavors of thenComparing method. One of them takes a Function (instead of a Comparator).
        It is this method that is being used here.
     ...
     and then compares that value. The value returned by the function must be Comparable.
        ...
        The third flavor of thenComparing is similar to the second
        except that the value returned by the function is compared using a given Comparator:
        public <U> Comparator<T>
             thenComparing(Function<? super T,? extends U> keyExtractor,
...
public class Book {
    ...
    public static void main(String... args){
       // And the following code:
        ...
        List<Book> books = new ArrayList<>();//code to create the list goes here
