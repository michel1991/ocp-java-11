...
/**
   Consider the following code:
    ...
    If the write lock is not free, a read lock cannot be locked.
    The write lock can be locked (by calling lock.writeLock().lock() )
    ...
    should acquire a read lock and threads that modify a collection should acquire a write lock.
