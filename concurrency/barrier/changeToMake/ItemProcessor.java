package concurrency.barrier.changeToMake;
...
/**
 Given:
    ...
    What should be inserted in the following code such that run method of Merger will
    be executed only after the thread started at 4 and the main thread have both invoked await?
     ...
     ------------------
     Briefly, a CyclicBarrier allows multiple threads to run independently but wait at one
     point until all of the coordinating threads arrive at that point.
