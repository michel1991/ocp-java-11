...
/**
 Consider the following code:
   ...
   ------------------------------------------------------
     Any checked exceptions must either be handled using a try block or the method that generates
     the exception must declare that it throws that exception.
    ...
    So, it must declare that it throws Exception. Now, the main() method is calling doB(),
    which generates an exception (due to a call to doA()).
