...
/**
 Which statement about the following program is true?
    ...
    The MissedCallException is a checked exception since
    it extends Exception and does not inherit RuntimeException.

     For this reason, the first catch block fails to compile,
     since the compiler detects that it is not possible to throw
     this checked exception inside the try block,
     making option D the correct answer.

     Note that if MissedCallException was changed
     to extend the unchecked RuntimeException class,
