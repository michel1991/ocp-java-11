...
/**
  ...
  Line 14 attempts to invoke the eat() method,
  which declares the checked exception IOException.
  
  Because main() neither handles nor declares the IOException,
  line 14 generates a compiler error.
