 ...
 * Which of the following exception classes must be handled or declared in the method in which they are thrown? (Choose three.)
    ...
    Since IOException and SQLException are checked exceptions, Happy and Grumpy are checked exceptions, respectively,
    making options A and F correct. Since Dopey inherits Grumpy, option B is also a checked exception.
