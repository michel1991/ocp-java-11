 ...
 *  Assuming that a valid integer will be passed in the command line as first argument, which statements regarding the following code are correct?
   ...
   It will say the following when compiled:
        ...
        Further, the expression in a switch statement must be of the type char, byte, short, int, Character, Byte, Short, Integer, String, or an enum.
        ...
        Here, the value of the expression x<5 is not constant. It is variable. So it is invalid.
    Correct(D)
