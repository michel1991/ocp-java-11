...
/**
   ...
   D. Compilation error at line marked //1.
        The main method is allowed to have a throws clause.
       
   E. Compilation error at line marked //2.
         This is a valid usage of var declaration.
        
   F.  Compilation error at line marked //3.
 ...
 can be used as types of a switch variable. String is allowed since Java 7.
  ...
  For example, if the switch variable is of type char, then none of the case constants can be greater than 65535 because a char's range is from 0 to 65535. For example, the following will not compile because 200 cannot be assigned to the variable b, which can only hold values from -128 to 127.
    byte b = 10;
    switch(b){
    ...
    4. All case labels should be COMPILE TIME CONSTANTS. This means, you can have literals such as 'a', 5, 10, or a final variable,
the value of which is computed at compile time such as int I = 2*3; For example, the following is valid:
    int x = 10;
    final int I = 2*3;
    switch(x){ 
...
public class ErrorLineMarkedTwo {
