package operations.switchs.findErrors;
/**
   ...
   -------------
    ...
    This gives compile time error as the compiler detects it while compiling. The use of break keyword is not mandatory,
    and without it the control will simply fall through the labels of the switch statement.
   Correct(B)
