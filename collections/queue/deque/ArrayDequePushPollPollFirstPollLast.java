...
public class ArrayDequePushPollPollFirstPollLast {
    /**
     *  What will the following code print when run?
        ...
        B. 3
                2
                1
        If you use push, objects will be added in the front and
        if you then use remove, items will be removed from the front.
        In this question, you push 1, 2, and 3, that means, the Deque now contains 3, 2, 1.
        Now, pollFirst() will return 3, poll() will return 2, and pollLast() will return 1.
...
You may want to check out the free video by Dr. Sean Kennedy explaining this question: https://youtu.be/A1CdZBvMwaM
