 ...
 * What will the following code print when run?
 ...
 B. 
    ...
    Now, when you call remove(), objects will be removed from the front and the first object removed will be 3.
 ...
 ---------------------------------------------
 Deque is an important interface for the exam. To answer the questions, you must remember that a Deque can act as a Queue as well as a Stack.
 Based on this fact, you can deduce the following:
    ...
    it has methods offer(e)/add(e)(for adding an element to the end or tail) and poll()/remove()(for removing an element from the front or head)
    for this purpose.  Note that offer and add are similar while poll and remove are similar.
    ...
    Well, they are not exactly same. add(e) throws an exception if the element cannot be added to the queue because of lack of capacity,
