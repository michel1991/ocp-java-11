...
/**
 dentify the correct statements about the following code:
   ...
   D. It will print 300.0
    ...
    the exception is rethrown, and no mapping is recorded. The most common usage is to construct a new object serving
    as an initial mapped value or memorized result, as in:
    ...
    3. public V computeIfPresent(K key,
         BiFunction<? super K,? super V,? extends V> remappingFunction)
