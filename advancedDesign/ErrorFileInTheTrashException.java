 ...
 */
public class ErrorFileInTheTrashException extends IOException { // 2
    public void close() throws ErrorFileInTheTrashException { //  3:
        throw new ErrorFileInTheTrashException("Unable to close"); //  4:
    } //  5:
    public static void main(String[] args) throws Exception { //   6:
        try (var f = new ErrorFileInTheTrashException()) { // 7:
            throw new ErrorFileInTheTrashException("Thrown away"); //  8:
        } } //  9:
}