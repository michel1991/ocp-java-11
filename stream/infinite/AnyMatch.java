...
public class AnyMatch {
     ...
     * Which can fill in the blank to have the code print true?
        ...
        For the allMatch() operator,
        it sees that the first element in the stream does not match,
        and the code prints false.
        Similarly, the noneMatch() operator
        gets to the point where i is 6 and returns
        false because there is a match. Therefore, option A is correct.
