package lambda.accessVariable.members;
/**
*   Given the following methods, which lambda expressions can be used in the blank? (Choose all that apply.)
   ...
   Option A is incorrect because t is declared twice,
   in the lambda parameter list and in the lambda body.
   
   Option B is correct because b is also declared twice,
   as a local variable in the method and in the lambda parameter list.
   ...
   Option E is incorrect because the lambda expression is missing a semicolon (;)
   at the end of the return statement.
   
   Finally, option F is a valid lambda expression, albeit hard to look at.
   Remember, var can be used as a valid identifier, just not a valid type like a class name.
   Please never write a lambda expression like this!
...
public class Monkey {
    ...
    static void withFirstMainSolution(String... bananas){
        boolean done = false;
        for(var b : bananas) {
    ...
    static void withSecondMainSolution(String... bananas){
        boolean done = false;
        for(var b : bananas) {
    ...
    public static void main(String... bananas) {
        withFirstMainSolution();
        withSecondMainSolution("bananas");
    }
}